...
public class RandoopTest0 extends TestCase {
  ...
  public void test2() throws Throwable {
    ...
    // This behavior will recorded for regression testing.
    try {
      java.net.DatagramPacket var4 = new java.net.DatagramPacket(var1, 56755, 65507);
  ...
  public void test6() throws Throwable {
    ...
    // This behavior will recorded for regression testing.
    try {
      java.net.DatagramPacket var9 = new java.net.DatagramPacket(var0, 56756, 100, var7, 10);
      fail("Expected exception of type java.lang.IllegalArgumentException");
    } catch (java.lang.IllegalArgumentException e) {
      // Expected exception.
    }
  ...
  public void test9() throws Throwable {
    ...
    // Regression assertion (captures the current behavior of the code)
    assertTrue(var2 == 56774);
    
    // Regression assertion (captures the current behavior of the code)
    assertTrue(var3 == 56774);
  ...
  public void test12() throws Throwable {
    ...
    // Regression assertion (captures the current behavior of the code)
    assertTrue(var2 == 56777);
    
    // Regression assertion (captures the current behavior of the code)
    assertTrue(var3 == 56777);
  ...
  public void test14() throws Throwable {
    ...
    // This behavior will recorded for regression testing.
    try {
      java.net.DatagramSocket var1 = new java.net.DatagramSocket(56777);
      fail("Expected exception of type java.net.BindException");
    } catch (java.net.BindException e) {
      // Expected exception.
    }
  ...
  public void test16() throws Throwable {
    ...
    int var3 = com.sun.jmx.snmp.daemon.SnmpAdaptorServer.mapErrorStatus(56756, 100, 56759);
  ...
  public void test20() throws Throwable {
    ...
    int var2 = var0.getLocalPort();
    var0.setSoTimeout(1);
    var0.setReceiveBufferSize(56758);
    
    // Regression assertion (captures the current behavior of the code)
    assertTrue(var1 == 65507);
    
    // Regression assertion (captures the current behavior of the code)
    assertTrue(var2 == 56784);
  ...
  public void test25() throws Throwable {
    ...
    var2.setSoTimeout(56755);
    var2.setTrafficClass(1);
    java.net.InetAddress var9 = var2.getLocalAddress();
    com.sun.jmx.snmp.daemon.SnmpAdaptorServer var10 = new com.sun.jmx.snmp.daemon.SnmpAdaptorServer(false, 56759, var9);
