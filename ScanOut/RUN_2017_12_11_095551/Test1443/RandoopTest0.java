...
public class RandoopTest0 extends TestCase {
  ...
  public void test7() throws Throwable {
    ...
    java.net.NetworkInterface var4 = java.net.NetworkInterface.getByIndex(1);
    boolean var5 = var4.isLoopback();
    // The following exception was thrown during execution.
    // This behavior will recorded for regression testing.
    try {
      java.net.Inet6Address var6 = java.net.Inet6Address.getByAddress("", var2, var4);
      fail("Expected exception of type java.net.UnknownHostException");
    } catch (java.net.UnknownHostException e) {
      // Expected exception.
    }
  ...
  public void test23() throws Throwable {
    ...
    java.util.Enumeration var6 = var1.getInetAddresses();
  ...
  public void test25() throws Throwable {
    ...
    boolean var4 = var3.getInCheck();
    java.lang.ThreadGroup var5 = var3.getThreadGroup();
    // The following exception was thrown during execution.
    // This behavior will recorded for regression testing.
    try {
  ...
  public void test33() throws Throwable {
    ...
    // Regression assertion (captures the current behavior of the code)
    assertTrue("'" + var3 + "' != '" + "lo0"+ "'", var3.equals("lo0"));
