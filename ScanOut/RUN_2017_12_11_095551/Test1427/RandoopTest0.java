...
public class RandoopTest0 extends TestCase {
  ...
  public void test13() throws Throwable {
    ...
    java.net.NetworkInterface var4 = java.net.NetworkInterface.getByInetAddress(var0);
    java.util.Enumeration var5 = var4.getInetAddresses();
  ...
  public void test14() throws Throwable {
    ...
    // This behavior will recorded for regression testing.
    try {
      java.net.SocketPermission var2 = new java.net.SocketPermission("lo0", "");
      fail("Expected exception of type java.lang.IllegalArgumentException");
    } catch (java.lang.IllegalArgumentException e) {
      // Expected exception.
    }
  ...
  public void test15() throws Throwable {
    ...
    boolean var6 = var4.isReachable(100);
    boolean var7 = var4.isMCSiteLocal();
    java.net.NetworkInterface var8 = java.net.NetworkInterface.getByInetAddress(var4);
    java.lang.String var9 = var8.getDisplayName();
    // The following exception was thrown during execution.
    // This behavior will recorded for regression testing.
    try {
      java.net.Inet6Address var10 = java.net.Inet6Address.getByAddress("hi!", var3, var8);
      fail("Expected exception of type java.net.UnknownHostException");
    } catch (java.net.UnknownHostException e) {
      // Expected exception.
    }
    ...
    // Regression assertion (captures the current behavior of the code)
    assertTrue("'" + var9 + "' != '" + "lo0"+ "'", var9.equals("lo0"));
  ...
  public void test17() throws Throwable {
    ...
    boolean var3 = var0.isMCSiteLocal();
    java.net.NetworkInterface var4 = java.net.NetworkInterface.getByInetAddress(var0);
    boolean var5 = var0.isLinkLocalAddress();
    java.net.NetworkInterface var6 = java.net.NetworkInterface.getByInetAddress(var0);
    boolean var8 = var0.isReachable(0);
  ...
  public void test18() throws Throwable {
    ...
    // Regression assertion (captures the current behavior of the code)
    assertTrue("'" + var5 + "' != '" + "name:lo0 (lo0)"+ "'", var5.equals("name:lo0 (lo0)"));
  ...
  public void test19() throws Throwable {
    ...
    // This behavior will recorded for regression testing.
    try {
      java.net.InetAddress var1 = java.net.InetAddress.getByName("name:lo0 (lo0)");
      fail("Expected exception of type java.net.UnknownHostException");
    } catch (java.net.UnknownHostException e) {
      // Expected exception.
    }
  ...
  public void test21() throws Throwable {
    ...
    boolean var3 = var0.isMCSiteLocal();
    java.net.NetworkInterface var4 = java.net.NetworkInterface.getByInetAddress(var0);
    boolean var5 = var4.isPointToPoint();
    java.util.Enumeration var6 = var4.getSubInterfaces();
  ...
  public void test23() throws Throwable {
    ...
    boolean var4 = var2.isReachable(100);
    boolean var5 = var2.isMCSiteLocal();
    java.net.NetworkInterface var6 = java.net.NetworkInterface.getByInetAddress(var2);
  ...
  public void test28() throws Throwable {
    ...
    boolean var3 = var0.isMCSiteLocal();
    java.net.NetworkInterface var4 = java.net.NetworkInterface.getByInetAddress(var0);
    boolean var5 = var4.isVirtual();
    java.net.NetworkInterface var6 = var4.getParent();
  ...
  public void test30() throws Throwable {
    ...
    boolean var9 = var0.isMCLinkLocal();
  ...
  public void test31() throws Throwable {
    ...
    java.net.NetworkInterface var1 = java.net.NetworkInterface.getByName("lo0");
