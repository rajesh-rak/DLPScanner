...
public class RandoopTest0 extends TestCase {
  ...
  public void test2() throws Throwable {
    ...
    try {
      java.net.Inet6Address var3 = java.net.Inet6Address.getByAddress("", var1, 10);
  ...
  public void test5() throws Throwable {
    ...
    // This behavior will recorded for regression testing.
    try {
      java.net.Inet6Address var5 = java.net.Inet6Address.getByAddress("hi!", var3, 1);
      fail("Expected exception of type java.net.UnknownHostException");
    } catch (java.net.UnknownHostException e) {
      // Expected exception.
    }
  ...
  public void test9() throws Throwable {
    ...
    java.util.List var6 = var5.getInterfaceAddresses();
    // The following exception was thrown during execution.
    // This behavior will recorded for regression testing.
    try {
      java.net.Inet6Address var7 = java.net.Inet6Address.getByAddress("hi!", var3, var5);
      fail("Expected exception of type java.net.UnknownHostException");
    } catch (java.net.UnknownHostException e) {
      // Expected exception.
    }
  ...
  public void test15() throws Throwable {
    ...
    java.util.List var3 = var2.getInterfaceAddresses();
  ...
  public void test19() throws Throwable {
    ...
    // Regression assertion (captures the current behavior of the code)
    assertTrue("'" + var1 + "' != '" + "java.security.Permissions@423a346f (\n)\n"+ "'", var1.equals("java.security.Permissions@423a346f (\n)\n"));
  ...
  public void test20() throws Throwable {
    ...
    // Regression assertion (captures the current behavior of the code)
    assertTrue("'" + var4 + "' != '" + "awdl0"+ "'", var4.equals("awdl0"));
    
    // Regression assertion (captures the current behavior of the code)
    assertTrue("'" + var5 + "' != '" + "awdl0"+ "'", var5.equals("awdl0"));
  ...
  public void test22() throws Throwable {
    ...
    // This behavior will recorded for regression testing.
    try {
      var0.checkConnect("name:lo0 (lo0)", 100, (java.lang.Object)1.0f);
  ...
  public void test26() throws Throwable {
    ...
    java.net.NetworkInterface var6 = java.net.NetworkInterface.getByIndex(10);
    boolean var8 = var6.equals((java.lang.Object)1.0f);
    // The following exception was thrown during execution.
    // This behavior will recorded for regression testing.
    try {
      boolean var11 = var0.isReachable(var6, (-1), 1);
      fail("Expected exception of type java.lang.IllegalArgumentException");
    } catch (java.lang.IllegalArgumentException e) {
      // Expected exception.
    }
  ...
  public void test28() throws Throwable {
    ...
    var0.checkPackageAccess("java.security.Permissions@423a346f (\n)\n");
    // The following exception was thrown during execution.
    // This behavior will recorded for regression testing.
    try {
