...
public class RandoopTest0 extends TestCase {
  ...
  public void test16() throws Throwable {
    ...
    // This behavior will recorded for regression testing.
    try {
      java.net.URL var4 = new java.net.URL("", "java.security.Permissions@35eb4667 (\n)\n", 1, "hi!");
      fail("Expected exception of type java.net.MalformedURLException");
    } catch (java.net.MalformedURLException e) {
      // Expected exception.
    }
  ...
  public void test19() throws Throwable {
    ...
    // Regression assertion (captures the current behavior of the code)
    assertTrue("'" + var1 + "' != '" + "java.security.Permissions@500b6585 (\n)\n"+ "'", var1.equals("java.security.Permissions@500b6585 (\n)\n"));
    
    // Regression assertion (captures the current behavior of the code)
    assertTrue("'" + var2 + "' != '" + "java.security.Permissions@500b6585 (\n)\n"+ "'", var2.equals("java.security.Permissions@500b6585 (\n)\n"));
  ...
  public void test20() throws Throwable {
    ...
    // This behavior will recorded for regression testing.
    try {
      java.net.URL var4 = new java.net.URL("java.security.Permissions@4dd1bb4d (\n)\n", "hi!", 10, "java.security.Permissions@500b6585 (\n)\n");
      fail("Expected exception of type java.net.MalformedURLException");
    } catch (java.net.MalformedURLException e) {
      // Expected exception.
    }
  ...
  public void test21() throws Throwable {
    ...
    var0.engineSetKeyEntry("java.security.Permissions@4dd1bb4d (\n)\n", var9, var10);
  ...
  public void test24() throws Throwable {
    ...
    // This behavior will recorded for regression testing.
    try {
      java.net.URL var4 = new java.net.URL("java.security.Permissions@500b6585 (\n)\n", "java.security.Permissions@4dd1bb4d (\n)\n", 1, "java.security.Permissions@500b6585 (\n)\n");
      fail("Expected exception of type java.net.MalformedURLException");
    } catch (java.net.MalformedURLException e) {
      // Expected exception.
    }
  ...
  public void test27() throws Throwable {
    ...
    java.security.cert.Certificate[] var16 = var10.engineGetCertificateChain("hi!");
    boolean var17 = var2.containsValue((java.lang.Object)var10);
    var2.clear();
