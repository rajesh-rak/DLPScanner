...
public class RandoopTest0 extends TestCase {
  ...
  public void test17() throws Throwable {
    ...
    var1.setSendBufferSize(1);
    int var4 = var1.getReceiveBufferSize();
    java.net.InetAddress var5 = var1.getLocalAddress();
    // The following exception was thrown during execution.
    // This behavior will recorded for regression testing.
    try {
      com.sun.jmx.snmp.daemon.SnmpAdaptorServer var6 = new com.sun.jmx.snmp.daemon.SnmpAdaptorServer(0, var5);
      fail("Expected exception of type java.lang.IllegalArgumentException");
    } catch (java.lang.IllegalArgumentException e) {
      // Expected exception.
    }
